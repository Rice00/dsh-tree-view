...
async function tree(ctx, sessionId) {
  ...
  // user reported. A fork that kept talking after the copy stays, because it
  // genuinely has new turns.
  //
  // The root and deleted versions are exempt: the trunk is never a copy, and a
  // deleted version is a node the panel draws as a ghost.
